...
/* harmony import */ var _modules_functions_lazy_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _modules_form_select_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _modules_page_modal_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var _modules_form_checkbox_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
/* harmony import */ var _modules_page_spollers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6);
/* harmony import */ var _modules_functions_moveElement_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7);
...
(0,_modules_functions_lazy_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
(0,_modules_form_checkbox_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
(0,_modules_form_select_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
(0,_modules_page_spollers_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
(0,_modules_functions_moveElement_js__WEBPACK_IMPORTED_MODULE_6__["default"])();
(0,_modules_page_modal_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
checkTextLength();
...
const showLangs = (lang) => {
    const langContainer = document.querySelector('.lang__container');
    lang.classList.toggle('_active');
    langContainer.classList.toggle('_active');
}

const hideLangs = () => {
    const langContainer = document.querySelector('.lang__container');
    const lang = document.querySelector('.lang__checked');
    lang.classList.remove('_active');
    langContainer.classList.remove('_active');
}

const sortApply = (sortItem) => {
    const form = sortItem.closest('form');
    form.submit();
}
...
function checkTextLength() {
    const text = document.querySelector('.item__desc');
    const btn = text.nextElementSibling;

    if (text && text.scrollHeight <= text.getBoundingClientRect().height) {
        text.classList.add('full');
        btn.classList.add('disable');
    } else {
...
document.addEventListener('click', (e) => {
    const closeMenuBtn = e.target.closest('.menu__close');
    if (closeMenuBtn) {
        closeMenu();
    }

    const menuBtn = e.target.closest('.header__menu-icon');
    if (menuBtn) {
        showMenu();
    }
    ...
    if (!select) {
        (0,_modules_form_select_js__WEBPACK_IMPORTED_MODULE_2__.selectClose)();
    }

    // const langOption = e.target.closest('.lang .select__option label');
    // if (langOption) {
    //     changeLang(langOption);
    // }

    const langSelect = e.target.closest('.lang__checked');
    if (langSelect) {
    ...
    const filterBtn = e.target.closest('.catalog__filter-btn');
    if (filterBtn) {
        showFilter();
    }

    const filterCloseBtn = e.target.closest('.filter__close');
    if (filterCloseBtn) {
        hideFilter();
    }
    ...
    const sortItem = e.target.closest('.news__sort label');
    if (sortItem) {
        sortApply(sortItem);
    }

    const showMoreBtn = e.target.closest('.item__more');
    if (showMoreBtn) {
...
document.addEventListener('wpcf7mailsent', (e) => {
    ...
    modalDone.classList.add('_active');
}, false);

// const changeLang = (option) => {
//     const lang = option.parentElement.dataset.lang;
//     const path = window.location.pathname;
//     const pathArr = path.split('/').filter(element => element !== '');

//     let newPath = '';

//     if (lang == 'en' && pathArr.includes(lang)) {
//         return
//     } else if (lang == 'en' && pathArr.length > 0 && pathArr[pathArr.length - 1].includes('html')) {
//         pathArr.splice([pathArr.length - 1], 0, lang);
//     } else if (lang == 'ua' && !pathArr.includes('en')) {
//         return
//     } else if (lang == 'ua' && pathArr.includes('en')) {
//         let index = pathArr.indexOf('en');
...
let banner = new swiper__WEBPACK_IMPORTED_MODULE_7__["default"]('.banner__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_8__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_8__.Autoplay],
    observer: true,
    observeParents: true,
...
let feedbacks = new swiper__WEBPACK_IMPORTED_MODULE_7__["default"]('.feedbacks__slider', {
    ...
    slidesPerView: 1,
    navigation: {
        prevEl: ".feedbacks__navigation .navigation__prev",
        nextEl: ".feedbacks__navigation .navigation__next"
    },
    breakpoints: {
        576: {
            slidesPerView: 2,
...
let brands = new swiper__WEBPACK_IMPORTED_MODULE_7__["default"]('.brands__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_8__.Navigation],
    spaceBetween: 12,
    observer: true,
    observeParents: true,
    ...
    slidesPerView: 1,
    navigation: {
        prevEl: ".brands__navigation .navigation__prev",
        nextEl: ".brands__navigation .navigation__next"
    },
    breakpoints: {
        576: {
            slidesPerView: 2,
...
let sertificates = new swiper__WEBPACK_IMPORTED_MODULE_7__["default"]('.sertificates__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_8__.Navigation],
    spaceBetween: 10,
    observer: true,
    observeParents: true,
...
let thumbs = new swiper__WEBPACK_IMPORTED_MODULE_7__["default"]('.thumbs__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_8__.Thumbs],
    observer: true,
    observeParents: true,
    observeSlideChildren: true,
    spaceBetween: 8,
...
let item = new swiper__WEBPACK_IMPORTED_MODULE_7__["default"]('.image-item__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_8__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_8__.Thumbs],
    observer: true,
    observeParents: true,
    observeSlideChildren: true,
    slidesPerView: 1,
    navigation: {
        prevEl: ".image-item__navigation .navigation__prev",
        nextEl: ".image-item__navigation .navigation__next"
    },
    thumbs: {
        swiper: thumbs,
    },
