...
// import burger, { burgerClose } from './modules/functions/burger.js';
...
document.addEventListener('click', (e) => {
    ...
    const langOption = e.target.closest('.select__option label');
    if (langOption) {
...
const changeLang = (option) => {
    ...
    // if (pathArr.length && !pathArr.includes(lang)) {
    //     for (let index = 0; index < pathArr.length; index++) {
    //         const pathElem = pathArr[index];

    //         if (pathElem !== 'en' && pathElem !== 'travmamed') {
    //             newPath += pathElem;
    //         } else {
    //             newPath += '/' + pathElem;
    //         }
    ...
    //     if (pathArr.length > 0 && !pathArr.includes('travmamed')) {
    //         newPath = lang + '/' + pathArr[pathArr.length - 1];
    //         window.location.href = newPath;
    //     } else {
    //         newPath = lang;
    //         window.location.href = newPath;
    //     }
    // } else if (lang == 'ua' && path.includes('en')) {
    //     if (pathArr.length > 1 && !pathArr.includes('travmamed')) {
    //         newPath = url + pathArr[pathArr.length - 1];
    //         window.location.href = newPath;
    //     } else if (pathArr.length > 1 && pathArr.includes('travmamed')) {
    //         newPath = url + pathArr[pathArr.length - 1];
    //         window.location.href = newPath;
    //     } else {
    //         newPath = url;
    ...
    // if (lang == 'en' && !path.includes('en')) {
    //     newPath = `${lang}${path}`;
    // } else if (lang == 'en' && path.includes('en')) {
    //     newPath = `${path.split('/')[pathArr.length - 2]}`;
    // } else if (lang == 'ua' && path.includes('en')) {
    //     newPath = `/${path.split('/')[pathArr.length - 2]}`;
    // } else {
    //     newPath = `/${path.split('/')[pathArr.length - 1]}`;
    // }
