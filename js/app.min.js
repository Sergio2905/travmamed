...
/* harmony import */ var _modules_form_checkbox_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var _modules_page_spollers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
/* harmony import */ var _modules_functions_moveElement_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6);
...
const selectClose = () => {
    ...
    const selectCheckedBtns = document.querySelectorAll('.select__checked');
    ...
    if (selectCheckedBtns.length) {
        selectCheckedBtns.forEach((selectCheckedBtn) => {
            selectCheckedBtn.classList.remove('_active');
        });
    }
}

const selectShow = (btn) => {
    const selectContainer = btn.previousElementSibling;
...
const selectOption = (btn) => {
    const container = btn.closest('.select__container');
    const checked = container.nextElementSibling;

    container.classList.remove('_active');
    checked.classList.remove('_active');
}
...
const checkTextLength = () => {
    ...
    if (text) {
        ...
        if (text.scrollHeight <= text.getBoundingClientRect().height) {
            text.classList.add('full');
            btn.classList.add('disable');
        } else {
...
(0,_modules_form_checkbox_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
(0,_modules_page_spollers_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
(0,_modules_functions_moveElement_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
...
document.addEventListener('click', (e) => {
    ...
    const selectChecked = e.target.closest('.select__checked');
    if (selectChecked) {
        selectShow(selectChecked);
    }

    const selectOptionBtn = e.target.closest('.select__option');
    if (selectOptionBtn) {
        selectOption(selectOptionBtn);
    }
...
let banner = new swiper__WEBPACK_IMPORTED_MODULE_6__["default"]('.banner__slider', {
...
let feedbacks = new swiper__WEBPACK_IMPORTED_MODULE_6__["default"]('.feedbacks__slider', {
...
let brands = new swiper__WEBPACK_IMPORTED_MODULE_6__["default"]('.brands__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_7__.Navigation],
    spaceBetween: 12,
    observer: true,
    observeParents: true,
...
let sertificates = new swiper__WEBPACK_IMPORTED_MODULE_6__["default"]('.sertificates__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_7__.Navigation],
    spaceBetween: 10,
    observer: true,
    observeParents: true,
...
let thumbs = new swiper__WEBPACK_IMPORTED_MODULE_6__["default"]('.thumbs__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_7__.Thumbs],
    observer: true,
    observeParents: true,
    observeSlideChildren: true,
    spaceBetween: 8,
...
let item = new swiper__WEBPACK_IMPORTED_MODULE_6__["default"]('.image-item__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_7__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_7__.Thumbs],
    observer: true,
    observeParents: true,
    observeSlideChildren: true,
    slidesPerView: 1,
