...
const changeLang = (option) => {
    ...
    if (lang == 'en' && !path.includes('en') && !pathArr.includes('travmamed')) {
        newPath = pathArr.length > 0 ? lang + '/' + pathArr[pathArr.length - 1] : lang;
        window.location.href = newPath;
    } else if (lang == 'ua' && path.includes('en') && !pathArr.includes('travmamed')) {
        newPath = pathArr.length > 1 ? url + pathArr[pathArr.length - 1] : url;
        window.location.href = newPath;
    }
    ...
    console.log(pathArr);
    console.log(newPath);
    console.log(pathArr.includes('travmamed'));
} 
})();
